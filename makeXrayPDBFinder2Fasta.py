...
for hetGroupName in open(os.path.join(scriptdir,'unallowed-hetgroups.txt'),'r'):
...
errorTemplates=open(os.path.join(scriptdir,'error-templates.txt'),'r').read().lower().split()
